...
const TrustedBrands = () => {
  const companies = [
    ...
    { name: "Descon Engineering", code: "DESCON", color: "bg-gray-600" },
    ...
    <section className="py-20 bg-gray-800">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {companies.map((company, index) => (
            <div key={index} className="group">
              <div className="bg-gray-700/50 border border-gray-600 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-xl transition-all duration-300 group-hover:-translate-y-2">
        ...
        <div className="text-center mt-16">
          <div className="inline-flex items-center bg-gray-700/50 border border-gray-600 backdrop-blur-sm rounded-full px-8 py-4 shadow-lg">
            <span className="text-2xl font-bold text-orange-500 mr-2">500+</span>
            <span className="text-gray-200 font-medium">Companies Trust Our Services</span>
          </div>
        </div>
      </div>
    </section>
